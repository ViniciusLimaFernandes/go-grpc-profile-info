...
type UserResponse struct {
	...
	AvatarURL  string      `protobuf:"bytes,4,opt,name=AvatarURL,json=avatarURL,proto3" json:"AvatarURL,omitempty"`
...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x0a, 0x09, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x55, 0x52, 0x4c, 0x18, 0x04, 0x20, 0x01, 0x28,
	...
	0x52, 0x05, 0x67, 0x69, 0x73, 0x74, 0x73, 0x32, 0x34, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x25, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0c,
...
var file_proto_user_proto_depIdxs = []int32{
	...
	0, // 1: UserService.User:input_type -> UserRequest
	1, // 2: UserService.User:output_type -> UserResponse
...
func (c *userServiceClient) User(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/UserService/User", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
